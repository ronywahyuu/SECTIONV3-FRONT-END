...
const About = () => {
  return (
    <div className="">
      {/* wrapper */}
      <div className="flex md:flex-row flex-col items-center justify-center lg:px-40 px-10 py-20 md:py-0 mx-auto h-screen">
        {/* logo */}
        ...
        {/* text */}
        <div className="flex flex-col gap-3 flex-1 md:px-0 px-16 ">
