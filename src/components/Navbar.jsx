  ...
  return (
    <nav className="flex md:px-40 px-10 py-5 justify-between items-center bg-primary  lg:w-screen animate-fade-in-down  ">
      ...
      <div className="flex gap-2 z-20">
        <Link to="/register">
          <button className="bg-gradient-to-r from-[#5334B1] to-[#401881] md:px-5 md:py-3 md:flex hidden text-white rounded-lg drop-shadow-[0_5px_15px_#ffffff3f] hover:drop-shadow-[0_35px_35px_#ffffff3f] transition duration-500">
            Daftar Peserta
          </button>
        </Link>
